...
try {
    ...
    if (isset($_POST["nuevo_periodo"])) {
        $newData["periodo"] = CValidadorDeEntradas::validarOpciones($_POST["nuevo_periodo"], [1, 2, 3]);
    }

    if (isset($_POST["nuevo_anio"])) {
        $newData["anio"] = CValidadorDeEntradas::validarEnteros($_POST["nuevo_anio"], "Nuevo año de la Carga Académica", false, false, false,false);
    ...
    if (isset($_POST["nueva_fecha_inicio"])) {
        $newData["fecha_inicio"] = CValidadorDeEntradas::validarString($_POST["nueva_fecha_inicio"], "Nueva fecha de inicio de la carga académica", 10, false, false, false);
    }

    if (isset($_POST["nueva_fecha_final"])) {
        $newData["fecha_final"] = CValidadorDeEntradas::validarString($_POST["nueva_fecha_final"], "Nueva fecha de cierre de la carga académica", 10, false, false, false);
    }
