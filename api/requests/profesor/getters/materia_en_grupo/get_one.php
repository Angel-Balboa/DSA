...
try {
    ...
    $dataMateriaEnGrupo["profesor"] = Usuario::get_usuario_by_id($dataMateriaEnGrupo["id_materia_en_grupo"])->get_data(["nombre", "apellidos"]);
    $json->estableceExito(true);
    $json->agregaDatos($dataMateriaEnGrupo);
} catch (ValorNoNumericoException | ValoresEnterosNoValidosException | MateriaEnGrupoNoExisteException $e) {
