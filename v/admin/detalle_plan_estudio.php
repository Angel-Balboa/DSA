...
<body class="">
        ...
        <form id="frmDatosPlanEstudio" action="" method="">
          <div class="modal-body">
            <div class="form-row form-group">
              ...
              <div class="col-md">
                <input type="text" id="txtNuevaClavePlan" name="nueva_clv_plan" class="form-control" maxlength="50" required>
              </div>
            </div>
            <div class="form-row form-group">
              <label class="col-md control-label" for="txtNuevoNombrePlan">Nombre</label>
              <div class="col-md">
                <input type="text" id="txtNuevoNombrePlan" name="nombre_plan" class="form-control" maxlength="250" required>
              </div>
            </div>
            <div class="form-row form-group">
              <label class="col-md-2 control-label" for="sctNuevoAnioPlan">Año de Registro</label>
              <div class="col-md-4">
                <select class="form-control selectpicker" id="sctNuevoAnioPlan" name="anio_plan" data-style="btn btn-link">
                  <?php
              ...
              <div class="col-md-4">
                <select class="form-control selectpicker" id="sctNuevoNivelPlan" name="nivel_plan" data-style="btn btn-link">
  ...
  <script src="../../static/js/admin/detalle_plan_estudio.js"></script>
  <!-- end Core JS Files -->
  <script>
