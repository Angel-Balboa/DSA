                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md">
                                        <button class="btn btn-primary" id="btnEditarCarrerasImparte" type="button">
                                            Editar
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                <form action="" id="frmEditarDatosUsuario" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="sctTipoUsuario" name="tipo_usuario" required>
...
<!-- modal: EditarProfesorImparteEn -->
<div  id="EditarProfesorImparteEn" aria-hidden="true" aria-labelledby="EditarProfesorImparteEnLabel" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="" id="frmProfesorImparteEn" method="post">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="frmEditarPerfilProfesor" method="post">
                    ...
                    <input id="hdnTypeAction" name="tipo_accion" type="hidden" value="">
                    <div class="form-group row">
...
?>
<script src="../../static/js/admin/detalle_usuario.js"></script>
<script>
