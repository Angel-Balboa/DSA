              ...
              <div class="card-body">
                  ...
                  <form class="form-inline">
                    ...
                    <div class="col-lg">
                      <div class="form-group">
                        <select class="form-control selectpicker" data-style="btn btn-link" id="sctFiltroTipo" multiple data-selected-text-format="count" title="Tipo">
                    ...
                    <div class="col-lg">
                      <div class="form-group">
                        <select class="form-control selectpicker" data-style="btn btn-link" id="sctFiltroUsuarioActivo" multiple data-selected-text-format="count" title="Activos">
                ...
                <div class="row table-responsive">
                  <table class="table table-hover" id="tblUsuarios">
                    ...
                    <tbody id="tbListadoUsuarios">
                    </tbody>
                  </table>
                </div>
              </div> <!-- end card-body -->
              <div class="card-footer">
                <button class="btn btn-primary" id="btnAgregarUsuario" type="button">Agregar Usuario
                </button>
              </div>
            </div> <!-- end card-->
          </div> <!-- end col -->
...
<div class="modal fade" id="VistaRapidaUsuario" tabindex="-1" role="dialog" aria-labelledby="VistaRapidaUsuarioLabel" aria-hidden="true">
          ...
          <div class="card" id="crdPerfilProfesor">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">Categoria - <div id="qv-categoria-profesor"></div></div>
              </div>
              <div class="row">
...
<div class="modal fade" id="mdlAgregarUsuario" tabindex="-1" role="dialog" aria-labelledby="mdlAgregarUsuarioLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form id="frmNuevoUsuario" action="" method="post">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row form-group">
                <div class="col-md">
                  <label for="sctTipoNuevoUsuario">Tipo</label>
                  <select class="form-control selectpicker" id="sctTipoNuevoUsuario" data-style="btn btn-link">
            ...
            <div class="card-body">
              ...
              <div class="row form-group">
                <div class="col-md-8">
                  ...
                  <select class="form-control selectpicker" id="sctCarreraAdscNuevoProfesor" data-style="btn btn-link" required>
                  </select>
                </div>
                <div class="col-md-4">
...
<script src="../../static/js/admin/lista_usuarios.js"></script>
<script>
