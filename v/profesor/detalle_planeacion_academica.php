                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Planeación Académica: <span id="periodo_anio" class="font-weight-bold"></span> - <span id="profesor"><?php echo $sesion->nivel_adscripcion . " " . $sesion->nombre_usuario["nombre"] . " " . $sesion->nombre_usuario["apellidos"] ?></span> </h4>
                            </div>
                            <div class="card-body">
...
<!--   end Core JS Files   -->
<script src="../../static/js/profesor/detalle_planeacion_academica.js"></script>
<script>
    $(document).ready(function() {
        ...
        sss("id_profesor", <?php echo $sesion->id_profesor; ?>, false);
        initd();
    });
</script>
</body>
